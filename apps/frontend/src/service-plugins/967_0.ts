...
/**
 * Service-specific plugin for: 967.0 
 *
...
const plugin: ServiceFormPlugin = {
  validateField(fieldCode, value, allValues) {
    // Validate: Mother's Date of Marriage (UK-FCL-03235_0) must be >= Mother's DOB (UK-FCL-03234_0)
  ...
  getFieldDefaultValue(fieldCode, _values) {
    ...
    const stateFields = [
      'UK-FCL-03243_0', // Permanent/Above State
      'UK-FCL-03189_0', // Correspondence State
      'UK-FCL-03320_0', // Another State field
    ];
    
    // District fields default to Nashik
    const districtFields = [
      'UK-FCL-03124_0', // Permanent/Above District
      'UK-FCL-03188_0', // Correspondence District
      'UK-FCL-03321_0', // Another District field
    ];
