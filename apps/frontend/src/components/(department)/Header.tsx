...
export default function DepartmentHeader() {
    ...
    return (
        <header className="investor-bg investor-headerflex items-center justify-between shrink-0 d-flex flex-col">
            <div className="flex items-center justify-between px-4 py-2 w-100">
                {/* Left: Search */}
                <div className="relative w-[320px] hidden md:block">
                    ...
                    <input
                        type="text"
                        placeholder="Search..."
                        className="w-full h-[50px] pl-12 pr-4 py-2 border-1 rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-[var(--primary-color)]"
                    />
                </div>
                    ...
                    <div className="relative">
                        ...
                        {showProfile && (
                            <div className="absolute right-0 mt-3 w-44 bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden z-50">
                                <Link href="/department/profile" className="flex items-center px-4 py-2 text-sm text-slate-700 hover:bg-slate-100">
                                    My Profile
                                </Link>
